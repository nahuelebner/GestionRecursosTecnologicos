...
namespace Gestion_Recursos_Tecnológicos
{
    public partial class PantallaRegistrarMantenimiento : Form
    {
        ...
        int indiceFila;
        List<bool> valoresChechBoxNotificacion;
        #endregion
        ...
        private void PantallaRegistrarMantenimiento_Load(object sender, EventArgs e)
        {
            ...
            notificarViaMail.Checked = true;
            notificarViaWhatsApp.Checked = false;
        }
        ...
        public void tomarFormaNotificacion()
        {
            valoresChechBoxNotificacion = new List<bool>();
            valoresChechBoxNotificacion.Add(notificarViaMail.Checked);
            valoresChechBoxNotificacion.Add(notificarViaWhatsApp.Checked);

            gestor.tomarFormaNotificacion(valoresChechBoxNotificacion);
        }
